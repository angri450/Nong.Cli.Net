...
/// <summary>
///     Represents the content of an area chart.
/// </summary>
internal sealed class AreaChartGenerator(
    ChartPart chartPart,
    ...
    string seriesName)
{
    public void Generate()
    {
        ...
        var series = new AreaChartSeries(new DocumentFormat.OpenXml.Drawing.Charts.Index { Val = 0 }, new Order { Val = 0 });
        ...
        var plotArea = new PlotArea(
            new Layout(), new DocumentFormat.OpenXml.Drawing.Charts.AreaChart(
