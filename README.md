...
<p align="center">
  ...
  Zero JavaScript. Modular architecture: one light router plus 6 external dotnet tools.
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/commands-cli--generated-green" alt="Commands generated by CLI">
...
<pre><code>nong (Angri450.Nong.Cli)
  built in: word / excel / inspect / lit / aminer / metaso / genre / icons / slice / skill
...
<p>Current local discovery from the built binary returns <code>167 commands available</code> with <code>meta.version = "4.3.0"</code>. Re-run <code>nong commands --json</code> whenever exact availability matters.</p>
...
<table>
  ...
  <tr><td><code>pdf</code></td><td>13</td><td>Check, dissect, render, images, merge, split, OCR, compress, db import/list/block/image workflows</td></tr>
...
<ul>
  <li>The publishable tool surfaces are <code>Angri450.Nong.Cli</code> and the six <code>Angri450.Nong.Tool.*</code> packages listed above.</li>
  ...
  <li>Current Chart, Diagram, and Imaging tool packages use the Windows native asset strategy. Linux/macOS users should build from source or wait for a dedicated native runtime packaging pass.</li>
</ul>
